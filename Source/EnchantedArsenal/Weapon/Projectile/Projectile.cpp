...
AProjectile::AProjectile() {
	...
	ProjectileMovementComp = CreateDefaultSubobject<UProjectileMovementComponent>("Projectile Movment Component");
...
void AProjectile::OnHit(UPrimitiveComponent* HitComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit) {
	...
	if (AArsenalPlayerState::IsHostile(GetInstigator(), OtherActor)) {
		if (UHealthComponent* HealthComp = OtherActor->GetComponentByClass<UHealthComponent>()) {
